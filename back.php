...
<!-- Mirrored from html-templates.multipurposethemes.com/bootstrap-4/admin/minimaladmin/pages/forms/form-validation.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Jan 2019 18:00:56 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Minimal Admin - Dashboard  Form Validation </title>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          <a href="#">
            <i class="fa fa-edit"></i> <span>Gerer Avis</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="back.php">Consulter les Sujets</a></li>
            <li><a href="back.php">Consulter les reponses</a></li>
