...
<!--main-->
    <table>
                    ...
                    <form method="POST" >
                        ...
                        <table align="center">
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td><input style="color: #ff8b1b" class="btn btn-danger" type="submit" name="modifier" value="modifier" href="afficher_reclamation.<?php  ?>" > <a  ></a>  </td>
        ...
        if (isset($_POST['modifier'])){
            ...
            header('Location: modifreclamation.php');
        }
        ?>
    </table>
