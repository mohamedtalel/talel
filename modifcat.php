...
<!-- Mirrored from html-templates.multipurposethemes.com/bootstrap-4/admin/minimaladmin/pages/forms/general.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Jan 2019 17:59:56 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <link rel="icon" href="http://html-templates.multipurposethemes.com/bootstrap-4/admin/minimaladmin/images/favicon.ico">

    <title>Minimal Admin - Dashboard  General Form Elements </title>
...
<div class="wrapper">
    ...
    <header class="main-header">
        <!-- Logo -->
        <a href="http://html-templates.multipurposethemes.com/bootstrap-4/admin/minimaladmin/index.html" class="logo">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">id_categorie</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" placeholder="id_categorie"  id="id_categorie" name="id_categorie" value="<?PHP echo $id_categorie ?>"/>


                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">nom_categorie</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" placeholder="nom_categorie"  id="nom_categorie" name="nom_categorie" value="<?PHP echo $nom_categorie ?>"/>
                                    ...
                                    <div>
                                        <input type="hidden" name="id_cat_ini" value="<?PHP echo $_GET['id_categorie'];?>">
                                    </div>



                                    <!--<button onclick="VerifProduit()"></button>-->
...
<!--
            <script>
                function VerifCategorie() {
                    ...
                    else if (nom_categorie.length<4)
                    {
                        alert("le champ nom_categorie doit avoir un nombre de caractere superieur a 4");
                        return ;
                    }
                ...
                function VerifProduit(){
                    var ajouter =document.getElementById("ajouter_produit").value;
                    ...
                    if((id == "") || (nom == "") || (prix == "") || (quantite == "")  ||(description == "") )
                    {
                    ...
                    {
                        alert("le champ nom doit avoir un nombre de caractere superieur a 4");
                        return ;
                    }
                    else if ((image == "")){

                        alert("veuillez inserer une image du produit !");
                        return
                    }
                    else if (id<=0 ){
                        console.log("negative");
...
<!-- Mirrored from html-templates.multipurposethemes.com/bootstrap-4/admin/minimaladmin/pages/forms/general.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Jan 2019 18:00:27 GMT -->
</html>
