...
<div class="container blog-main">
    ...
    <div class="col-md-8">
        ...
        <div class="row">
         ...
         <form id="Topic"   method="POST" action="ajouterTopic.php">   
<dl>
        <dt>Insert a categorie that belongs to the topic , the list is on your right</dt></br>
          <label></label> <input type="radiobutton" name="categories" placeholder="Categorie" >
</dl>     
            <div class="col-sm-6 col-md-6"><input class="" type="text"  name="name"  id="nom" required pattern="[a-zA-Z-\.]{3,20}"  placeholder="Name" required></div>
            <div class="col-sm-6 col-md-6"><input class="" type="email" name="email"    id="email"    placeholder="Email" required ></div>
            <div class="col-sm-6 col-md-6"><input class="" type="text"  name="topic"     id="topic"   placeholder="Topic"  required></div>
            <div class="col-sm-6 col-md-6"><input class="" type="date"  name="datetime"   id="date"   placeholder="Enter creation date" required></div>
            <div class="col-sm-12 col-md-12"><textarea class=""  name="detail"   id="message"         placeholder="What are you thinking about ?" required></textarea></div>
...
<script src="revolution/js/topic.js"></script>
